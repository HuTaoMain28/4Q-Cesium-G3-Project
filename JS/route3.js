//Boss data containing details about each boss
        const bossData = [
            ...
            { name: "Mirexa, the Venomous Sovereign", description: "A serpentine queen slithers forth, her venom dripping with malice.", image: "Images/mirexa.png", maxHP: 50, actions: ["Spits a stream of venom!", "Constricts with her massive coils!"] },
            { name: "Varzhul, the Hollowed King", description: "A celestial guardian descends, its hollow eyes glowing with ancient power.", image: "Images/varzhul.png", maxHP: 60, actions: ["Summons a rain of celestial fire!", "Strikes with a blade of starlight!"] },
        ];
        ...
        function attack(index) {
            ...
            const bossHit = guaranteedCrit ? 10 : getRandom(1, 10); // Guaranteed critical hit if enabled
        ...
        function buyCrit(index) {
            guaranteedCrit = true; //Enable guaranteed critical
            nextChapter(index); //Proceed to next chapter
        }
